...
class Mart:
    def _init_(self,ans,name,COGS,Sales,
               VCost,FCost,Intrst,
    ...
    def Leverage(self):
        ...
        print('If the sales increase by 1%, the Earnings Per Share will increasse by {} % and vice versa.'.format(round(DTL,3)))
    ...
    def Discount(self):
        if self.ans == True:
            ...
            CDisc = round(cdisc,4)
            return ('The Annual Cost of Discount is:',CDisc*100,'percent.')  
        
"""The Code examines Cycles and Determines The Leverage
                    OPtional Ans are Cycles Analysis or Leverage Analysis """      

  
print('Cycles Analysis or Leverage Analysis')
IAns              = input('Enter the Analysis Being Carried out:')
if IAns.lower().split() == 'Cycle Analysis'.lower().split():
    prj = Mart()
    ...
    print('The Analysis for the client is:',prj.Analysis())
    prj.Discount()
